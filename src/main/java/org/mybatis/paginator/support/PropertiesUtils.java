package org.mybatis.paginator.support;
 ...
 * 	   static PropertiesUtils props = new PropertiesUtils(properties);
 ...
 * }
 * 指定是否搜索系统属性:
 * new PropertiesUtils(properties,PropertiesUtils.SYSTEM_PROPERTIES_MODE_OVERRIDE)
 * </pre>
 *
 * @author badqiu
 */
public class PropertiesUtils {
    ...
    public Properties getStartsWithProperties(String prefix) {
        if (prefix == null) throw new IllegalArgumentException("'prefix' can not null");
